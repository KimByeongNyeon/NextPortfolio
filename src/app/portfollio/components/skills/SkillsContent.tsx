...
export default function SkillsContent() {
  ...
  useAnimationFrame((_, delta) => {
    ...
    const totalWidth = skills.length * (224 + 48); // w-56(224px) + space-x-12(48px)
    const speed = totalWidth / (skills.length * 2 * 1000); // px/ms
    let newX = carouselX.get() - delta * speed;
  ...
  const skills: Skill[] = [
    {
      ...
      color: "#61DAFB",
      description:
        "컴포넌트 기반 라이브러리로 재사용 가능한 UI를 구축하고, 상태 관리와 생명주기를 효율적으로 다룹니다.",
      capabilities: [
    ...
    },
    {
      ...
      color: "#000000",
      description:
        "React 기반 풀스택 프레임워크로 SSR, SSG, API Routes를 활용한 최적화된 웹 애플리케이션을 개발합니다.",
      capabilities: [
    ...
    },
    {
      ...
      color: "#4FC08D",
      description:
        "직관적이고 유연한 프로그레시브 프레임워크로 반응형 웹 애플리케이션을 구축합니다.",
      capabilities: [
    ...
    },
    {
      ...
      color: "#3178C6",
      description:
        "정적 타입 검사를 통해 안전하고 확장 가능한 JavaScript 코드를 작성합니다.",
      capabilities: [
        "제네릭 활용",
        "인터페이스와 타입 별칭 활용",
        "유니온 타입과 인터섹션 타입 활용",
    ...
    },
    {
      ...
      color: "#F7DF1E",
      description:
        "ES6+ 문법과 최신 JavaScript 기능을 활용하여 효율적인 웹 애플리케이션을 개발합니다.",
      capabilities: [
    ...
    },
    {
      ...
      color: "#06B6D4",
      description:
        "tailwindCSS의 유틸리티 클래스를 활용하여 직관적이고 효율적인 UI를 구현합니다.",
      capabilities: [
    ...
    },
    {
      ...
      color: "#E34F26",
      description:
        "시맨틱 마크업과 웹 표준을 준수하여 접근성과 SEO에 최적화된 웹 구조를 설계합니다.",
      capabilities: [
    ...
    },
    {
      ...
      color: "#1572B6",
      description:
        "최신 CSS 기능과 레이아웃 시스템을 활용하여 직관적인 UI를 구현합니다.",
      capabilities: [
...

    {
      ...
      color: "#0055FF",
      description:
        "React를 위한 애니메이션 라이브러리로 부드럽고 인터랙티브한 사용자 경험을 제공합니다.",
      capabilities: [
    ...
    },
    {
      ...
      color: "#764ABC",
      description:
        "예측 가능한 상태 관리를 통해 복잡한 애플리케이션의 데이터 플로우를 체계적으로 관리합니다.",
      capabilities: [
    ...
    },
    {
      ...
      color: "#F05032",
      description:
        "버전 관리 시스템을 활용하여 효율적인 협업과 코드 이력 관리를 수행합니다.",
      capabilities: [
    ...
    },
    {
      ...
      color: "#F24E1E",
      description:
        "디자인 시스템과 프로토타입을 구축하여 개발자와 디자이너 간의 원활한 협업을 지원합니다.",
      capabilities: [
...

    {
      ...
      color: "#000000",
      description:
        "JAMstack과 서버리스 아키텍처를 활용하여 확장 가능한 웹 애플리케이션을 배포합니다.",
      capabilities: [
  ...
  return (
    <div
      className="w-full bg-white dark:bg-black text-gray-900 dark:text-white transition-colors duration-500"
      ref={containerRef}
    >
      <style jsx>{`
        ...
        <div className="text-center max-w-4xl mx-auto px-6 relative z-10">
          ...
          >
            <motion.div
              ...
              style={{ width: "fit-content", x: carouselX }}
            >
