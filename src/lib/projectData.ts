...
export const projects: Project[] = [
  ...
  },
  {
    ...
    detailedDescription:
      "학생과 교사 모두의 현장체험학습 어플이며 학생은 지루한 현장체험을 보다 재미있게 즐길 수 있고 교사는 편리하게 현장체험학습 관리 및 보고서 작성이 가능합니다.",
    ...
    detailedFeatures: [
      {
        category: "출석 및 위치 관리",
        items: ["만족도 조사를 통한 출석 관리", "팀원 위치 확인 기능"],
      },
      {
        category: "학습 지원",
        items: [
  ...
  },
  {
    ...
    detailedDescription:
      "복잡하고 어려운 금융 교육을 게임과 같은 재미있는 경험으로 바꾼 혁신적인 플랫폼입니다. 실제 소비 데이터를 분석하여 개인화된 금융 교육을 제공하고, 귀여운 고양이 캐릭터와 함께 즐겁게 학습할 수 있습니다.",
  ...
  },
  {
    ...
    description:
      "Next.js와 TypeScript를 활용하여 개발한 개인 포트폴리오 웹사이트입니다. 모던한 디자인과 부드러운 애니메이션을 적용하여 방문자에게 인상적인 경험을 제공합니다.",
    detailedDescription:
      "최신 웹 기술을 활용하여 개발한 개인 포트폴리오 사이트입니다. 현재 계속 작업중에 있습니다.",
